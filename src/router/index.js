...
export const constantRoutes = [{
    ...
    },
    {
        ...
        children: [{
            ...
            },
            {
                ...
                name: 'Message',
                component: () =>
                    import ('@/views/dashboard/MessagePage'),
    ...
    // 医院管理
    {
        ...
        children: [{
            ...
            },
            {
                ...
                name: 'Employee',
                component: () =>
                    import ('@/views/hospital/employee'),
    ...
    // 报表查询
    {
        ...
        children: [{
            ...
            },
            {
                ...
                children: [{
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('@/views/report/children/basicMedicineAndMaterial'),
            ...
            // 门诊报表查询
            {
                ...
                name: 'Outpatient',
                component: () =>
                    import ('@/views/report/outpatient'),
    ...
    // 数据分析
    {
        ...
        children: [{
            ...
            // 门诊分析
            {
                ...
                name: 'Outpatient',
                component: () =>
                    import ('@/views/dataAna/outpatient'),
            ...
            // 住院分析
            {
                ...
                name: 'Intpatient',
                component: () =>
                    import ('@/views/dataAna/inpatient'),
    ...
    // 报表定制
    {
        ...
        children: [{
            ...
            },
            {
                ...
                name: 'SpecialQuery',
                component: () =>
                    import ('@/views/reportmake/specialQuery'),
                ...
                children: [{
                        ...
                        name: 'DeptOperate',
                        component: () =>
                            import ('@/views/reportmake/children/deptOperate'),
                        meta: { title: '科室收入情况' },
                        hidden: true
                    },
                    {
                        ...
                        component: () =>
                            import ('@/views/reportmake/children/deptMaterialProportion'),
                        meta: { title: '住院科室耗占比' },
                        hidden: true
                    },
                    {
                        ...
                        component: () =>
                            import ('@/views/reportmake/children/deptMedicineProportion'),
                        meta: { title: '门诊和住院药占比' },
                        hidden: true
                    },
                    {
                        ...
                        component: () =>
                            import ('@/views/reportmake/children/deptMaterialMedicineDetail'),
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('@/views/reportmake/children/deptMaterialAmountTop20'),
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import ('@/views/reportmake/children/deptMaterialSorted'),
                        meta: { title: '科室使用金额排名' },
                        hidden: true
                    }
                ]
    ...
    // 业务办理
    {
        ...
        children: [{
                ...
                name: 'Personal',
                component: () =>
                    import ('@/views/bussinessManager/index'),
            ...
            },
            {
                ...
                name: 'Department',
                component: () =>
                    import ('@/views/bussinessManager/department'),

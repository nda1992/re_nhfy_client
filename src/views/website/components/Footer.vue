  ...
  <div class="main">
      ...
      <div class="line1">
        ...
        <span
          ><a href="https://beian.miit.gov.cn/"
            >版权所有：湘ICP备05005356号-1 湘卫网审字(2001)27号</a
          ></span
        >
    ...
    <div slot="footer">
      <el-dialog title="请输入您的建议" :visible.sync="openDialogvisible">
        <el-form ref="adviceForm" :model="adviceForm" :rules="rules">
...
<script>
import { FOOTER_QRCODE_DOWNLOAD } from '@/utils/urlConfig'
import { submitAdvice } from '@/api/advice/advice'
export default {
  data() {
    return {
      qrcode_url: FOOTER_QRCODE_DOWNLOAD,
      openDialogvisible: false,
      adviceForm: { content: '' },
      rules: {
        content: [
          { required: true, trigger: 'blur', message: '输入内容不能为空' }
        ]
      }
    }
  },
